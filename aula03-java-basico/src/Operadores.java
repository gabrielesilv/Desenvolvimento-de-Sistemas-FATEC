...
public class Operadores {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("\n=== LÓGICOS ===");
        System.out.println("Pode dirigir (idade é maior ou igual a 18 E possui carteira): " + (idade >= 18 && temCarteira));

        System.out.println("Pode dirigir (idade é menor que 18 OU possui carteira): " + (idade < 18 || temCarteira));

        System.out.println("Não possui carteira (negação da condição): " + (!temCarteira));
        ...
        System.out.println("E bit a bit entre num1 e num2 (somente bits iguais a 1 permanecem): " + (num1 & num2));

        System.out.println("Ou bit a bit entre num1 e num2 (bits que possuem pelo menos um 1): " + (num1 | num2));

        System.out.println("Ou exclusivo entre num1 e num2 (bits diferentes resultam em 1): " + (num1 ^ num2));

        System.out.println("Inversão dos bits de num1 (negação bit a bit): " + (~num1));

        System.out.println("Deslocamento de bits de num1 para a esquerda em 1 posição (multiplica por 2): " + (num1 << 1));

        System.out.println("Deslocamento de bits de num1 para a direita em 1 posição (divide por 2): " + (num1 >> 1));
